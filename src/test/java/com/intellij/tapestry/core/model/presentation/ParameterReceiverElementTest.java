...
public class ParameterReceiverElementTest {
    ...
    public void getParameters_with_parameters() {
        ...
        assertEquals(new TapestryComponent(_libraryMock, _classInSubComponentsPackageMock, _tapestryProjectMock).getParameters().size(), 2);
    }
    ...
    public void getOptionalParameters_with_parameters() {
        ...
        assertEquals(
          new TapestryComponent(_libraryMock, _classInSubComponentsPackageMock, _tapestryProjectMock).getOptionalParameters().size(), 2);
    }
