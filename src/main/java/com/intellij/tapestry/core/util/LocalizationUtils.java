...
public final class LocalizationUtils {
  ...
  private static final List<String> ALL_COUNTRIES = Arrays.<String>asList(Locale.getISOCountries());
  private static final List<String> ALL_LANGUAGES = Arrays.<String>asList(Locale.getISOLanguages());
