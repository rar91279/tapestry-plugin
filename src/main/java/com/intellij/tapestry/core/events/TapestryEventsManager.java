...
public class TapestryEventsManager implements FileSystemListener, TapestryModelChangeListener {
    ...
    private final List<FileSystemListener> _fileSystemListeners = ContainerUtil.<FileSystemListener>createLockFreeCopyOnWriteList();
    private final List<TapestryModelChangeListener> _tapestryModelChangeListeners = ContainerUtil.<TapestryModelChangeListener>createLockFreeCopyOnWriteList();
