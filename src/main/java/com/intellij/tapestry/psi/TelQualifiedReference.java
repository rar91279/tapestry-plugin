...
public abstract class TelQualifiedReference implements PsiPolyVariantReference {
  ...
  public final ResolveResult @NotNull [] multiResolve(final boolean incompleteCode) {
    return ResolveCache.getInstance(myElement.getProject()).<TelQualifiedReference>resolveWithCaching(this, MY_RESOLVER, true, false);
  }
  ...
  public Object @NotNull [] getVariants() {
    ...
    return ContainerUtil.<PsiNamedElement, LookupElement>map2Array(elements, LookupElement.class, element -> {
  ...
  public String getUnresolvedMessage(boolean resolvedWithError) {
    ...
    String argumentTypes = StringUtil.<PsiType>join(((TelMethodCallExpression)elementParent).getArgumentTypes(), psiType -> TelPsiUtil.getPresentableText(psiType), ", ");
