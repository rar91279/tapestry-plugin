...
public class TapestryTagDescriptor extends BasicTapestryTagDescriptor {
  ...
  private XmlAttributeDescriptor[] getAttributeDescriptors() {
    ...
    ContainerUtil.<XmlAttributeDescriptor, List<XmlAttributeDescriptor>>addAll(result, DescriptorUtil.getAttributeDescriptors((TapestryComponent)myComponent, null));
    for (Mixin mixin : myMixins) {
      ContainerUtil.<XmlAttributeDescriptor, List<XmlAttributeDescriptor>>addAll(result, DescriptorUtil.getAttributeDescriptors(mixin, null));
    }
    return result.<XmlAttributeDescriptor>toArray(XmlAttributeDescriptor.EMPTY);
  }
