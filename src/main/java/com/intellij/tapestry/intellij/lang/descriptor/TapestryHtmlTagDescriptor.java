...
public class TapestryHtmlTagDescriptor implements XmlElementDescriptor, PsiWritableMetaData {
  ...
  public XmlElementDescriptor[] getElementsDescriptors(XmlTag context) {
    ...
    return ArrayUtil.<XmlElementDescriptor>mergeArrays(htmlDescriptors, tapestryDescriptors);
  }
  ...
  public XmlAttributeDescriptor[] getAttributesDescriptors(@Nullable XmlTag context) {
    ...
    return ArrayUtil.<XmlAttributeDescriptor>mergeArrays(tapestryAttrs, myHtmlDelegate.getAttributesDescriptors(context));
  }
