    ...
    extend(null, psiElement(), new CompletionProvider<>() {
      ...
      protected void addCompletions(@NotNull CompletionParameters parameters,
        ...
        if (psiElement instanceof XmlToken && ((XmlToken)psiElement).getTokenType().toString().equals("XML_ATTRIBUTE_VALUE_TOKEN")) {
          ...
          XmlAttribute attribute = PsiTreeUtil.<XmlAttribute>getParentOfType(psiElement, XmlAttribute.class);

          // The selected tag
          XmlTag tag = PsiTreeUtil.<XmlTag>getParentOfType(psiElement, XmlTag.class);
