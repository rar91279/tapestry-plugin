...
public class TapestryMetaDataContributor implements MetaDataContributor {
  ...
  public void contributeMetaData(@NotNull MetaDataRegistrar registrar) {
    registrar.<TapestryNamespaceDescriptor>registerMetaData(new RootTagFilter(new TargetNamespaceFilter(TapestryXmlExtension.tapestryTemplateNamespaces())),
                                                     TapestryNamespaceDescriptor.class);
    registrar.<TapestryParametersNamespaceDescriptor>registerMetaData(new RootTagFilter(new TargetNamespaceFilter(TapestryConstants.PARAMETERS_NAMESPACE)),
