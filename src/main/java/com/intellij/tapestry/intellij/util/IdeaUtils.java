...
public final class IdeaUtils {
  ...
  public static boolean isModuleNode(AnActionEvent event) {
    final Project project = event.<Project>getData(CommonDataKeys.PROJECT);
    final Module module = event.<Module>getData(LangDataKeys.MODULE_CONTEXT);
  ...
  public static WebFacet getWebFacet(@NotNull Module module) {
    return FacetManager.getInstance(module).<WebFacet>getFacetByType(WebFacet.ID);
  }//getWebFacet
