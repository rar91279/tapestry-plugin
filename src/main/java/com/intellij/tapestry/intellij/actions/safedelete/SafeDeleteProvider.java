...
public class SafeDeleteProvider implements DeleteProvider {
  ...
  public @NotNull ActionUpdateThread getActionUpdateThread() {
    ...
    public void deleteElement(@NotNull DataContext dataContext) {
        ...
        Project project = dataContext.<Project>getData(CommonDataKeys.PROJECT);
        int numberChildren;
        ...
        for (TreePath treePath : TapestryProjectViewPane.getInstance(project).getSelectionPaths()) {
            ...
            if (((TapestryNode) node.getUserObject()).getElement() instanceof PsiFile) {
              ...
              ContainerUtil.<PsiElement, List<PsiElement>>addAll(totalElementsToDelete, elements);
            }
    ...
    public boolean canDeleteElement(@NotNull DataContext dataContext) {
        ...
        for (TreePath treePath : TapestryProjectViewPane.getInstance(project).getSelectionPaths()) {
            ...
            if (node.getUserObject() instanceof PackageNode && IdeaUtils.<LibrariesNode>findFirstParent(node, LibrariesNode.class) == null) {
                canDelete = true;
            }
