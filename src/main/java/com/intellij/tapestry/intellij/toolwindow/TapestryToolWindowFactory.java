...
public class TapestryToolWindowFactory implements ToolWindowFactory {
  ...
  private static final Key<TapestryToolWindow> TAPESTRY_TOOL_WINDOW_KEY = Key.<TapestryToolWindow>create("tapestry.toolWindow");
  ...
  public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
    ...
    project.<TapestryToolWindow>putUserData(TAPESTRY_TOOL_WINDOW_KEY, tapestryToolWindow);
  }
  ...
  public static TapestryToolWindow getToolWindow(Project project) {
    ...
    return toolWindow == null ? null : project.<TapestryToolWindow>getUserData(TAPESTRY_TOOL_WINDOW_KEY);
  }
}
