...
public class IntellijJavaTypeCreator implements IJavaTypeCreator {
    ...
    public boolean ensureClassImport(final IJavaClassType baseClass, final IJavaClassType type) {
        ...
        if (packageName.equals("java.lang")) {
            ...
            final PsiJavaFile javaFile = (PsiJavaFile)((IntellijJavaClassType) baseClass).getPsiClass().getContainingFile();
            IdeaUtils.runWriteCommand(
              null, () -> JavaCodeStyleManager.getInstance(_module.getProject())
                .addImport(javaFile, ((IntellijJavaClassType) type).getPsiClass()));
            return true;
