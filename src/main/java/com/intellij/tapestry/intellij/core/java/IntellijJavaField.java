...
public class IntellijJavaField implements IJavaField {
    ...
    public String getDocumentation() {
        ...
        if (document == null) {
            // getNavigationElement() may be a non-Java (e.g. Kotlin KtProperty) element, which has no Javadoc.
            PsiElement navigationElement = _psiField.getNavigationElement();
            if (navigationElement instanceof PsiField navigationField) {
                document = navigationField.getDocComment();
            }
        }
