...
public class IntellijJavaClassType extends IntellijJavaType implements IJavaClassType {
  ...
  public String getDocumentation() {
    ...
    if (document == null) {
      // getNavigationElement() may be a non-Java (e.g. Kotlin KtClass) element, which has no Javadoc.
      PsiElement navigationElement = psiClass.getNavigationElement();
      if (navigationElement instanceof PsiClass navigationClass) {
        document = navigationClass.getDocComment();
      }
    }
