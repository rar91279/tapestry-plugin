...
public class IntellijJavaMethod implements IJavaMethod {
    ...
    public String getDocumentation() {
        ...
        if (document == null) {
            // getNavigationElement() may be a non-Java (e.g. Kotlin) element, which has no Javadoc.
            PsiElement navigationElement = _psiMethod.getNavigationElement();
            if (navigationElement instanceof PsiMethod navigationMethod) {
                document = navigationMethod.getDocComment();
            }
        }
